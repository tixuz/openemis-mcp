---
title: "Риски учреждения — сводка рисков и правила оповещений в OpenEMIS"
description: "Руководство OpenEMIS по просмотру рисков учеников в учреждении, правил раннего предупреждения и журналов доставки оповещений. MCP для управления образованием."
keywords:
  - OpenEMIS
  - риски учеников
...
Это руководство OpenEMIS объясняет, как просмотреть конфигурацию рисков учеников в учреждении, правила раннего предупреждения и журналы оповещений через API школьной информационной системы OpenEMIS.
...
*Когда использовать: используйте это руководство, когда администратору нужно проверить конфигурацию рисков учеников и правила раннего предупреждения в OpenEMIS.*