---
title: "Расширение профиля ученика — контакты и особые потребности в OpenEMIS"
description: "Руководство OpenEMIS по расширению профиля ученика контактами, гражданством и записями об особых образовательных потребностях. MCP для управления образованием."
keywords:
  - OpenEMIS
...
Это руководство OpenEMIS объясняет, как расширить профиль ученика контактами, гражданством и данными об особых образовательных потребностях через API школьной информационной системы OpenEMIS.
...
*Когда использовать: используйте это руководство, когда нужно дополнить профиль ученика контактами, гражданством или данными об особых потребностях в OpenEMIS.*