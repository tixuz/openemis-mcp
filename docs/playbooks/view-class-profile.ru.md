---
title: "Профиль класса — список учеников и учителей в OpenEMIS"
description: "Руководство OpenEMIS по просмотру профиля класса: ученики, предметы, посещаемость, список учителей. MCP для управления образованием."
keywords:
  - OpenEMIS
...
Это руководство OpenEMIS объясняет, как просмотреть полный профиль класса — ученики, предметы, сводка посещаемости учеников и полный список учителей — через API школьной информационной системы OpenEMIS.
...
*Когда использовать: используйте это руководство, когда учителю или администратору нужен полный профиль класса — ученики, предметы, посещаемость и учителя — в OpenEMIS.*