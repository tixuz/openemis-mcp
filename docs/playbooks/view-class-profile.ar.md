---
title: "ملف الصف الدراسي — قائمة الطلاب والمعلمين في OpenEMIS"
description: "دليل OpenEMIS لعرض ملف الصف الكامل: الطلاب والمواد وحضور الطلاب وقائمة المعلمين. استعلام MCP لإدارة التعليم."
keywords:
  - OpenEMIS
  - نظام إدارة المدارس
  - حضور الطلاب
...
يشرح دليل OpenEMIS هذا كيفية عرض الملف الكامل للصف الدراسي — الطلاب المسجلون والمواد وملخص حضور الطلاب وقائمة المعلمين — باستخدام واجهة برمجة تطبيقات نظام إدارة المدارس OpenEMIS.
...
*متى تُستخدم: استخدم هذا الدليل عندما يحتاج معلم أو مدير إلى الملف الكامل للصف — الطلاب والمواد والمعلمون — في OpenEMIS.*