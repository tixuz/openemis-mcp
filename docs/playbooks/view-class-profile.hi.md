---
title: "कक्षा प्रोफ़ाइल — छात्र सूची और शिक्षक OpenEMIS में"
description: "OpenEMIS प्लेबुक जो कक्षा प्रोफ़ाइल दिखाती है: छात्र, विषय, छात्र उपस्थिति सारांश और शिक्षक सूची। शिक्षा प्रबंधन MCP गाइड।"
keywords:
  - OpenEMIS
...
यह OpenEMIS प्लेबुक बताती है कि OpenEMIS स्कूल प्रबंधन प्रणाली के API का उपयोग करके एक पूर्ण कक्षा प्रोफ़ाइल — छात्र, विषय, छात्र उपस्थिति सारांश और शिक्षक सूची — कैसे देखें।
...
*कब उपयोग करें: इस प्लेबुक का उपयोग करें जब शिक्षक या प्रशासक को OpenEMIS में कक्षा का पूर्ण प्रोफ़ाइल — छात्र, विषय और शिक्षक — चाहिए।*