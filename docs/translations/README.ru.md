...
description: "Бесплатный MCP-сервер для подключения AI-ассистентов к OpenEMIS — школьной информационной системе. Запрашивайте посещаемость учеников, риски и 675 ресурсов."
keywords:
  - OpenEMIS
...
> **Что это такое:** openemis-mcp — бесплатный MCP-сервер, который подключает AI-ассистентов к OpenEMIS — школьной информационной системе. Открывает доступ к 675 ресурсам (посещаемость учеников, риски учеников, персонал, экзамены) через 26 руководств только для чтения.
