...
description: "मुफ्त MCP सर्वर जो AI असिस्टेंट को OpenEMIS स्कूल प्रबंधन प्रणाली से जोड़ता है। छात्र उपस्थिति, जोखिम, स्टाफ और 678 संसाधन क्वेरी करें।"
keywords:
  - OpenEMIS
...
> **यह क्या है:** openemis-mcp एक मुफ्त MCP सर्वर है जो AI असिस्टेंट को OpenEMIS स्कूल प्रबंधन प्रणाली से जोड़ता है। यह 26 केवल-पढ़ने योग्य प्लेबुक्स के माध्यम से 678 संसाधन (छात्र उपस्थिति, छात्र जोखिम, स्टाफ, परीक्षाएं) उपलब्ध कराता है।
...
openemis-mcp  ←  6 पठन टूल + 26 प्लेबुक्स + 14 स्टब्स
        │ HTTPS + Bearer JWT
OpenEMIS Core API  /api/v5/{resource}   (3,361 एंडपॉइंट्स / 678 संसाधन, Core 5.13.0)
```

डोमेन-स्कोप्ड डिस्कवरी वार्तालापों को छोटा रखती है — `openemis_discover("attendance")` उपस्थिति से संबंधित 20–30 एंडपॉइंट्स लौटाता है, सभी 3,361 नहीं।
...
- [Resource Reference](docs/resources.md) — सभी 678 संसाधन विधि उपलब्धता के साथ (Core 5.13.0)
